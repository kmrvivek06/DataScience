...
class WindowMain(QMainWindow):
 def __init__(self):
    ...
    #Time Series Menu
    menuTS = self.menuBar()
    menu_TimeS = menuTS.addMenu("Time Series")
    menuinv = QAction(QIcon("../Pics/regression24.png"), "&ARIMA - Inventory", self)
    menuinv.setShortcut("Ctrl+i") #Shorcut
    menuinv.triggered.connect(self.openTS) #Launcher
    menu_TimeS.addAction(menuinv)
